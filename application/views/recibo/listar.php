                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="<?php echo site_url('') ?>quincena/mostrar">REGRESAR</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="row search-form-default">
                                <div class="col-md-12">
                                    <form action="<?php echo site_url('') ?>recibo/mostrar">
                                                            ...
                                                            if (isset($registros)) {
                                                                foreach ($registros->result() as $rowx) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $rowx->reestado; ?></td>

                                                                        <td>



                                                                            <a href="<?php echo site_url('') ?>recibo/editar?idrecibo=<?php echo $rowx->idrecibo ?>"    class="btn default btn-xs"><i class="fa fa-edit"></i> EDITAR</a>

                                                                            <a href="<?php echo site_url('') ?>pdfs/recibo?idrecibo=<?php echo $rowx->idrecibo ?>" target="_blank"  class="btn default btn-xs"> <i class="fa fa-file-o"></i> IMPRIMIR</a>
                                                                            <?php
                                                                            if ($rowx->reestado == 'ACTIVO') {
                                                                                ?>
                                                                                <a href="<?php echo site_url('') ?>recibo/actualizarestado?idrecibo=<?php echo $rowx->idrecibo ?>&estado=CERRADO&idquincena=<?php echo $idquincena; ?>"   class="btn default btn-xs"><i class="fa fa-font"></i> DESACTIVAR</a>
                                                                                <?php
                                                                            } else {
                                                                                ?>
                                                                                <a href="<?php echo site_url('') ?>recibo/actualizarestado?idrecibo=<?php echo $rowx->idrecibo ?>&estado=ACTIVO&idquincena=<?php echo $idquincena; ?>"    class="btn default btn-xs"><i class="fa fa-font"></i> ACTIVAR</a>
                                                                                <?php
                                                                            }
                                                                            ?>
