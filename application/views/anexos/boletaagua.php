                            ...
                            <div class="page-bar">
                                <ul class="page-breadcrumb">
                                    <li>
                                        ...
                                        <?php
                                        if (strcmp($puesto, 'Admin') == 0) {
                                            ?>
                                            <a href="<?php echo site_url('') ?>solicitudes/mostrar">REGRESAR</a>
                                            <i class="fa fa-angle-right"></i>

                                            <?php } else { ?>
                                            <a href="<?php echo site_url('') ?>registro/mostrarsolicitudes">REGRESAR</a>
                                            <i class="fa fa-angle-right"></i>
                                            <?php } ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="tabbable-line">
                                            <ul class="nav nav-tabs">
                                                <li >
                                                    <a href="<?php echo site_url('') ?>anexos/acreditado?idregistro=<?php echo $idregistro ?>" >
                                                        Acreditado <?php
                                                        if (!empty($arryCount["tipo_1"])) {
                                                            echo '<span style="color:red">* ' . $arryCount["tipo_1"] . '</span>';
                                                        }
                                                        ?></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo site_url('') ?>anexos/predial?idregistro=<?php echo $idregistro ?>" >
                                                            Predial <?php
                                                            if (!empty($arryCount["tipo_2"])) {
                                                                echo '<span style="color:red">* ' . $arryCount["tipo_2"] . '</span>';
                                                            }
                                                            ?></a>
                                                        </li>
                                                        <li>
                                                            <a href="<?php echo site_url('') ?>anexos/escritura?idregistro=<?php echo $idregistro ?>" >
                                                                Escritura <?php
                                                                if (!empty($arryCount["tipo_3"])) {
                                                                    echo '<span style="color:red">* ' . $arryCount["tipo_3"] . '</span>';
                                                                }
                                                                ?></a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo site_url('') ?>anexos/plano?idregistro=<?php echo $idregistro ?>" >
                                                                    Plano  <?php
                                                                    if (!empty($arryCount["tipo_4"])) {
                                                                        echo '<span style="color:red">* ' . $arryCount["tipo_4"] . '</span>';
                                                                    }
                                                                    ?> </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo site_url('') ?>anexos/vendedor?idregistro=<?php echo $idregistro ?>" >
                                                                        Vendedor <?php
                                                                        if (!empty($arryCount["tipo_5"])) {
                                                                            echo '<span style="color:red">* ' . $arryCount["tipo_5"] . '</span>';
                                                                        }
                                                                        ?></a>
                                                                    </li>
                                                                    <li class="active">
                                                                        <a href="<?php echo site_url('') ?>anexos/boletaagua?idregistro=<?php echo $idregistro ?>" >
                                                                            Boleta de Agua <?php
                                                                            if (!empty($arryCount["tipo_6"])) {
                                                                                echo '<span style="color:red">* ' . $arryCount["tipo_6"] . '</span>';
                                                                            }
                                                                            ?></a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="<?php echo site_url('') ?>anexos/licencia?idregistro=<?php echo $idregistro ?>" >
                                                                                Licencia de construcción <?php
                                                                                if (!empty($arryCount["tipo_7"])) {
                                                                                    echo '<span style="color:red">* ' . $arryCount["tipo_7"] . '</span>';
                                                                                }
                                                                                ?></a>
                                                                            </li>
                                                                            <li>
                                                                                <a href="<?php echo site_url('') ?>anexos/fotos?idregistro=<?php echo $idregistro ?>" >
                                                                                    Fotos <?php
                                                                                    if (!empty($arryCount["tipo_8"])) {
                                                                                        echo '<span style="color:red">* ' . $arryCount["tipo_8"] . '</span>';
                                                                                    }
                                                                                    ?></a>
                                                                                </li>
                                                                                <li>
                                                                                    <a href="<?php echo site_url('') ?>anexos/comentario?idregistro=<?php echo $idregistro ?>" >
                                                                                        Comentarios </a>
                                                                                    </li>
                                                                                </ul>
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                <div class="row search-form-default">
                                                                                                    <div class="col-md-12">
                                                                                                        <form action="<?php echo site_url('') ?>anexos/boletaagua">
                                                                                                        ...
                                                                                                        <div class="tab-pane active" id="tab_1">
                                                                                                            <div class="portlet box blue">
                                                                                                                <div class="portlet-title">
                                                                                                                    <div class="caption">
                                                                                                                        <i class="fa fa-gift"></i>ANEXOS BOLETA DE AGUA
                                                                                                                                    ...
                                                                                                                                    foreach ($registros->result() as $rowx) {
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td >
                                                                                                                                                ...
                                                                                                                                                <a href="<?php echo site_url('') ?>anexos/eliminararchivo?idarchivo=<?php echo $rowx->idarchivos ?>&tipo=<?php echo $tipoarchivo ?>"  class="btn default btn-xs">ELIMINAR</a>
