                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                                    ...
                                    <div class="portlet box blue">
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <form action="<?php echo site_url('') ?>registro/registroMasivo" method='post' enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                         Importar Archivo : <input type='file' accept=".csv" required name='sel_file' size='20'>
                                                                     </div>
                                                                 </div>
                                                                 <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <form action="<?php echo site_url('') ?>registro/registroMasivoCalculos" method='post' enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                 Importar Archivo : <input required type='file' accept=".csv" name='sel_file' size='20'>
                                                             </div>
                                                         </div>
                                    ...
                                    <div class="col-md-3"><hr><a href="<?php echo site_url('') ?>db/Plantilla.csv" class="btn btn-circle red">Plantilla CSV</a></div>
