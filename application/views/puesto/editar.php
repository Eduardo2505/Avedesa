                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="<?php echo site_url('') ?>puesto/mostrar">MOSTRAR</a>
                         ...
                         <script type="text/javascript">
                                ...
                                $(function() {
                                    $('#fromactualizar').submit(function() {
                                        ...
                                        $.get('<?php echo site_url('') ?>puesto/actualizar', data, function(respuesta) {
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="portlet box blue">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-gift"></i>EDITAR PUESTO
                                            </div>
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <form id="fromactualizar"  class="form-horizontal">
                                               <input type="hidden"  value="<?php echo $row->idcat_puesto; ?>" maxlength="45" name="idtipo" />
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">PUESTO: *</label>
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control input-circle" value="<?php echo $row->puesto; ?>" maxlength="45" name="tipo" placeholder="PUESTO" required="">
