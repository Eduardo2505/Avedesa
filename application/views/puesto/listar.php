                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="<?php echo site_url('') ?>puesto/">REGISTRAR</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="row search-form-default">
                                <div class="col-md-12">
                                    <form action="<?php echo site_url('') ?>puesto/mostrar">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if (isset($registros)) {
                                                                foreach ($registros->result() as $rowx) {
                                                                    ...
                                                                    <tr>
                                                                        <td><?php echo $rowx->idcat_puesto; ?></td>
                                                                        <td><?php echo $rowx->puesto; ?></td>

                                                                        <td>



                                                                            <a href="<?php echo site_url('') ?>puesto/editar?idregistro=<?php echo $rowx->idcat_puesto ?>"   class="btn default btn-xs optenerID"><i class="fa fa-edit"></i> EDITAR</a>
