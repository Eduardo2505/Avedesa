                              ...
                              <div class="tabbable-line boxless tabbable-reversed">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $obj_solicitante->CodigoPostal ?>"    onKeyPress="return soloNumeros(event)" name="cp_s" maxlength="6"   class="form-control" placeholder="C.P."/>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $obj_solicitante->Colonia ?>"  required=""  onkeyup="mayus(this);" name="col_s" maxlength="45"   class="form-control" placeholder="Colonia"/>
