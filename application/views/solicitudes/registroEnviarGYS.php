                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab_1">
                                        ...
                                        <?php if ($result==-1) { ?>
                                           <div class="alert alert-danger">
                                            <h3>Error</h3>
                                            <span>
                                             No se realizó la sincronización con GYS verifique los datos.</span>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <form action="<?php echo site_url('') ?>solicitudesWebService/editarCaptura" method="POST"  class="horizontal-form">
                                            ...
                                            <input type="hidden" value="1" name="tipoSnc">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required="" value="<?php echo $obj_registro->hora_de_inspeccion ?>" name="hora_de_inspeccion" class="form-control timepicker timepicker-24" >
                                    ...
                                    <div class="col-md-4">
                                       ...
                                       <!--  <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?php echo $obj_inmueble->Latitud ?>" onkeyup="mayus(this);" name="latitud_i" maxlength="45"   class="form-control inmuebleclass" placeholder="Latitud" required="" />
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?php echo $obj_inmueble->Longitud ?>" name="longitud_i" maxlength="45"   class="form-control" placeholder="Longitud inmuebleclass" required="" />
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"  value="<?php echo $obj_inmueble->Altitud ?>" name="altitud_i" maxlength="45"   class="form-control inmuebleclass" placeholder="Altitud" required="" />
