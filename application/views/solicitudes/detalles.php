                            ...
                            <div class="page-bar">
                                <ul class="page-breadcrumb">
                                    <li>
                                        ...
                                        <a href="<?php echo site_url('') ?>solicitudesvista">NUEVA BUSQUEDA</a>
                                        <i class="fa fa-angle-right"></i>
                                    </li>
                                  
                                    <li>
                                        <a href="<?php echo site_url('') ?>solicitudesvista/mostrar">VER SOLICITUDES</a>
                                    </li>
                                </ul>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-5">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" name="nomRefer" value="<?php echo $row->referencia ?>" placeholder="Nombre de referencia"  disabled="" required=""/>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" disabled="" class="form-control" value="<?php echo $row->num_expediente ?>" name="numExpediente" placeholder="Nombre de Expediente" />
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text"  class="form-control" maxlength="45"  value="<?php echo $row->num_avaluo ?>" disabled="" name="numavaluo" placeholder="Num. Avalúo" />
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="tel" name="telefono"  value="<?php echo $row->telefono ?>" maxlength="45"  class="form-control" disabled="" placeholder="Teléfono"/>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="email" name="email" value="<?php echo $row->email ?>"  maxlength="45"  class="form-control" disabled="" placeholder="Correo Electrónico"/>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select disabled="" class="form-control" required="" name="idtipo_avaluo">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select disabled="" class="form-control" name="objetivoAvaluo">
                                                                                <option value="">Seleccione</option>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input disabled="" type="text" maxlength="120" name="otros" value="<?php echo $row->otros ?>"  class="form-control" placeholder="Otros"/>
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <div class="form-group">
                                                                            <label>Costo:</label>
                                                                            <input disabled="" value="$ <?php echo number_format($row->costo, 0, ",", "."); ?>" maxlength="10" name="costo" class="form-control"  value="0"/>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-8">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea disabled=""class="form-control" maxlength="445" name="ubicacion" > <?php echo $row->ubicacion ?> </textarea>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select disabled="" class="form-control"  name="idempleado" >
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input disabled="" value=" $ <?php echo number_format($row->monto_credito, 0, ",", "."); ?>" maxlength="10" name="monto_credito" class="form-control" />
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input disabled="" name="monto_venta" maxlength="10" class="form-control"  value=" $ <?php echo number_format($row->monto_venta, 0, ",", "."); ?>"/>  
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input disabled="" value=" $ <?php echo number_format($row->adelanto_pago, 0, ",", "."); ?>" name="adelanto_pago" maxlength="10" class="form-control" />  
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" disabled="" value="<?php echo $row->nomIntermediria; ?>" class="form-control" name="intermediario" placeholder="Intermediario" />
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label>Asigno:</label>
                                                                            <select  disabled="" class="form-control" name="idasigno" >
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea disabled="" class="form-control" name="observaciones"> <?php echo $row->observaciones; ?></textarea>
                                                                        </div>
                                                                    </div>
                                                                    <!--/span-->
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select disabled="" class="form-control" name="idestado_registro"  required="">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd"  >
                                                                                <input disabled="" type="text" class="form-control" name="fecha_de_inspeccion"
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input disabled="" type="text" name="hora_de_inspeccion" maxlength="45"  value="<?php echo $row->hora_de_inspeccion ?>" class="form-control" placeholder="Hora"/>
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="form-group">
                                                                                <label>Entrega de visita:</label>
                                                                                    ...
                                                                                    <input type="text" class="form-control" disabled="" name="fecha_de_entrega" value=" <?php  if(!empty($arryCount["registro_3"])) {echo $arryCount["registro_3"]; }?>" disabled="" />
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" disabled="" value="<?php echo $row->usuario_entrega; ?>"  class="form-control" name="usuario_entrega"/>
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="input-group input-medium "  >
                                                                                    <input type="text" class="form-control" disabled=""name="fecha_asigancion" value=" <?php  if(!empty($arryCount["registro_4"])) {echo $arryCount["registro_4"]; }?>" disabled="">
                                                                                <!-- <span class="input-group-btn">
                                                                                    <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                                                                </span>  -->
                                                                            </div>
                                                                  ...
                                                                  <div class="row">
                                                                   ...
                                                                   <div class="form-actions right">
                                                                    ...
                                                                    <a href="<?php echo site_url('') ?>solicitudesvista/mostrar"   class="btn default">REGRESAR</a>
