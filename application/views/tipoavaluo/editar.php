                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="<?php echo site_url('') ?>tipoavaluo/mostrar">MOSTRAR</a>
                            ...
                            <script type="text/javascript">
                                ...
                                $(function() {
                                    $('#fromactualizar').submit(function() {
                                        ...
                                        $.get('<?php echo site_url('') ?>tipoavaluo/actualizar', data, function(respuesta) {
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="portlet box blue">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-gift"></i>REGISTRO TIPO AVALÚO
                                            </div>
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <form id="fromactualizar"  class="form-horizontal">
                                                <input type="hidden"  value="<?php echo $row->idtipo_avaluo; ?>" maxlength="45" name="idtipo" />
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Tipo: *</label>
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control input-circle" value="<?php echo $row->nombre; ?>" maxlength="45" name="tipo" placeholder="Tipo" required="">
