                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="<?php echo site_url('') ?>tipoavaluo/">REGISTRAR</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="row search-form-default">
                                <div class="col-md-12">
                                    <form action="<?php echo site_url('') ?>tipoavaluo/mostrar">
                                    ...
                                    <div class="tab-pane active" id="tab_1">
                                        <div class="portlet box blue">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>TIPO AVALÚO
                                                </div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if (isset($registros)) {
                                                                foreach ($registros->result() as $rowx) {
                                                                    ...
                                                                    <tr>
                                                                        <td><?php echo $rowx->idtipo_avaluo; ?></td>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <a href="<?php echo site_url('') ?>tipoavaluo/editar?idregistro=<?php echo $rowx->idtipo_avaluo ?>"   class="btn default btn-xs optenerID"> <i class="fa fa-edit"></i> EDITAR</a>
