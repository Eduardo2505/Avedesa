                            ...
                            <div class="page-bar">
                                <ul class="page-breadcrumb">
                                    <li>
                                        ...
                                        <a href="<?php echo site_url('') ?>concepto/mostrar">MOSTRAR</a>
                                  ...
                                  <script type="text/javascript">
                                    ...
                                    $(function() {
                                        $('#fromactualizar').submit(function() {
                                            ...
                                            $.get('<?php echo site_url('') ?>concepto/actualizar', data, function(respuesta) {
                                        ...
                                        <div class="portlet box blue">
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <form id="fromactualizar"  class="form-horizontal">
                                                  <input type="hidden"  value="<?php echo $row->idconcepto; ?>" maxlength="45" name="idtipo" />

                                                  <div class="form-body">
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">CONCEPTO: *</label>
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control input-circle" value="<?php echo $row->nombre; ?>" maxlength="45" name="tipo" placeholder="CONCEPTO" required="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <select name="estado" required="" class="form-control input-circle">
                                                               <option value="">Seleccione</option>
                                                               <?php if($row->estado==1){
                                                                ?>
                                                                <option value="1" selected="selected">OTROS</option>
                                                                <option value="2">CÁLCULO</option>
                                                                <option value="3">TIPO AVALÚO</option>
                                                               ...
                                                               <option value="2" selected="selected" >CÁLCULO</option>
                                                               <option value="3">TIPO AVALÚO</option>
                                                               ...
                                                               <option value="1">OTROS</option>
                                                               <option value="2" >CÁLCULO</option>
                                                               <option value="3" selected="selected">TIPO AVALÚO</option>
