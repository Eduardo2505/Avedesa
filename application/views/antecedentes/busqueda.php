                            ...
                            <div class="page-bar">
                                <ul class="page-breadcrumb">
                                    <li>
                                        ...
                                        <a href="<?php echo site_url('') ?>antecedentes">NUEVA BUSQUEDA</a>
                                        <i class="fa fa-angle-right"></i>
                                    </li>
                                    
                                    <li>
                                        <a href="<?php echo site_url('') ?>antecedentes/mostrar">VER ANTECEDENTES</a>
                                    </li>
                                </ul>
                                            ...
                                            <div class="tab-pane active" id="tab_1">
                                                <div class="portlet box blue">
                                                    ...
                                                    <div class="portlet-body form">
                                                        <!-- BEGIN FORM-->
                                                        <form action="<?php echo site_url('') ?>antecedentes/mostrar"  class="horizontal-form">
                                                            <div class="form-body">
