                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="<?php echo site_url('') ?>objetivo/mostrar">MOSTRAR</a>
                          ...
                          <script type="text/javascript">
                                ...
                                $(function() {
                                    $('#fromactualizar').submit(function() {
                                        ...
                                        $.get('<?php echo site_url('') ?>objetivo/actualizar', data, function(respuesta) {
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="portlet box blue">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-gift"></i>EDITAR TIPO AVALÚO
                                            </div>
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <form id="fromactualizar"  class="form-horizontal">
                                                <input type="hidden"  value="<?php echo $row->idobjetivo_avaluo; ?>" maxlength="45" name="idtipo" />
                                                <div class="form-body">
