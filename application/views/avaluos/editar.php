                ...
                <div class="col-md-12">
                    <div class="block">
                        ...
                        <div class="content" style="text-align: center">
                            ...
                            <a href="<?php echo site_url('') ?>estado/mostrar" class="widget-icon  widget-icon-circle"><span class="icon-time"></span></a> MOSTAR REGISTROS
                        </div>
                    </div>
                </div>  
            </div>     
                        ...
                        <div class="content controls">
                            ...
                            <form  id="fromactualizar" > 
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-9"><input type="text" class="form-control" value="<?php echo $row->estado; ?>" maxlength="45" name="tipo" placeholder="ESTADO" required=""/></div>
                                </div>
