                            ...
                            <script type="text/javascript">
                                ...
                                $(function() {
                                    $('#fromactualizar').submit(function() {
                                        ...
                                        $.get('<?php echo site_url('') ?>costoconcepto/actualizar', data, function(respuesta) {
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="portlet box blue">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-gift"></i>EDITAR CONCEPTOS
                                            </div>
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <form id="fromactualizar"  class="form-horizontal">
                                                <input type="hidden"  value="<?php echo $row->idcosto_concepto; ?>" maxlength="45" name="idtipo" />
                                                ...
                                                <div class="form-body">
                                                            ...
                                                            <select name="idconcepto" required="" class="form-control input-circle">
                                                                ...
                                                                if (isset($conceptos)) {
                                                                    foreach ($conceptos->result() as $rowx) {
                                                                        ...
                                                                        if ($row->idconcepto == $rowx->idconcepto) {
                                                                            ?>

                                                                            <option value="<?php echo $rowx->idconcepto; ?>" selected="selected"><?php echo $rowx->nombre; ?></option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control input-circle" value="<?php echo $row->costo; ?>" onKeyPress="return soloNumeros(event)" maxlength="5" name="costo" placeholder="COSTO" required=""/>
                                                        </div>
                                                    </div>
