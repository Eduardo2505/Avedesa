                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="<?php echo site_url('') ?>costoconcepto/mostrar">MOSTRAR</a>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="portlet box blue">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-gift"></i>REGISTRO CONCEPTO
                                            </div>
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                $(function() {
                                                    $('#formcap').submit(function() {
                                                        var data = $(this).serialize();

                                                        $('#mensaje').html("    <p> Procesando .......<p>");
                                                        $.post('<?php echo site_url('') ?>costoconcepto/registro', data, function(respuesta) {
                                                            $('#mensaje').html("<div class='block'><div class='alert alert-success'>   <h1> <b>Registro!</b> Se registro correctamente!</h1> <button type='button' class='close' data-dismiss='alert'>×</button></div></div>");
                                            ...
                                            <!-- BEGIN FORM-->
                                            <form id="formcap"  class="form-horizontal">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">CONCEPTO: *</label>
                                                        <div class="col-md-4">
                                                            <select name="idconcepto" required="" class="form-control input-circle">
                                                                <option value="">Seleccione</option>

                                                                <?php
                                                                if (isset($conceptos)) {
                                                                    foreach ($conceptos->result() as $rowx) {
                                                                        ?>


                                                                        <option value="<?php echo $rowx->idconcepto; ?>"><?php echo $rowx->nombre; ?></option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <select name="idempleado" required="" class="form-control input-circle">
                                                                <option value="">Seleccione</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control input-circle" onKeyPress="return soloNumeros(event)" maxlength="5" name="costo" placeholder="COSTO" required=""/>
                                                        </div>
                                                    </div>
