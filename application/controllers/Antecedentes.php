...
//HOls
    ...
    public function index() {
     ...
     $this->load->view('antecedentes/busqueda', $data);
 }
 ...
 public function mostrar() {
    ...
    $config['base_url'] = base_url() . 'antecedentes/mostrar?idGrpAve=' . $id.'&calle='.$calle.'&colonia='.$colonia.'&cp='.$cp.'&delegacion='.$delegacion.'&entidad='.$entidad.'&fecha='.$fecha.'&tipo='.$tipo.'&usuario='.$usuario.'&inicio='.$inicio.'&final='.$final;
    ...
    $config['total_rows']= $tt;
     ...
     $data['menu'] = $this->load->view('plantilla/menudos', $datax, true);
     $this->load->view('antecedentes/listar', $data);
 }
