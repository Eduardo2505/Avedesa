...
*/
    ...
    public function index() {
        ...
        $this->load->view('estado/registro', $data);
    }

    public function registro() {


        $vno = $this->input->post('tipo');
        if (!empty($vno)) {
            ...
            $valor = $this->models_estado_registro->insertar($data);
    ...
    public function mostrar() {
        ...
        $data['registros'] = $this->models_estado_registro->mostrar($nombre, $offset, $this->limite);

        $config['base_url'] = base_url() . 'estado/mostrar?nombre=' . $nombre;
        $config['total_rows'] = $this->models_estado_registro->mostrarcount($nombre);
        ...
        $data['menu'] = $this->load->view('plantilla/menu', $datax, true);
        $data['head'] = $this->load->view('plantilla/head', true);
        $this->load->view('estado/listar', $data);
    }
    ...
    public function actualizar() {
        ...
        $data = array(
            'estado' => $this->input->get('tipo'));

        $valor = $this->models_estado_registro->update($idregistro, $data);
    ...
    public function editar() {
        ...
        $data['menu'] = $this->load->view('plantilla/menu', $datax, true);
        $data['head'] = $this->load->view('plantilla/head', true);
        $data['query'] = $this->models_estado_registro->Buscar($idregistro);

        $this->load->view('estado/editar', $data);
    }
