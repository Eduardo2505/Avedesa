...
class Tipoavaluo extends CI_Controller {
...
*/
    ...
    public function index() {
        ...
        $this->load->view('tipoavaluo/registro', $data);
    }

    public function registro() {


        $vfr = $this->input->post('tipo');
        if (!empty($vfr)) {
            ...
            $valor = $this->models_tipo_avaluo->insertar($data);
    ...
    public function mostrar() {
        ...
        $data['registros'] = $this->models_tipo_avaluo->mostrar($nombre, $offset, $this->limite);

        $config['base_url'] = base_url() . 'tipoavaluo/mostrar?nombre=' . $nombre;
        $config['total_rows'] = $this->models_tipo_avaluo->mostrarcount($nombre);
        ...
        $data['menu'] = $this->load->view('plantilla/menu', $datax, true);
        $data['head'] = $this->load->view('plantilla/head', true);
        $this->load->view('tipoavaluo/listar', $data);
    }
    ...
    public function actualizar() {
        ...
        $valor = $this->models_tipo_avaluo->update($idregistro, $data);
    ...
    public function editar() {
       ...
       $datax['nombre'] = $nombrez;
        ...
        $data['menu'] = $this->load->view('plantilla/menu', $datax, true);
        $data['head'] = $this->load->view('plantilla/head', true);
        $data['query'] = $this->models_tipo_avaluo->Buscar($idregistro);

        $this->load->view('tipoavaluo/editar', $data);
    }
