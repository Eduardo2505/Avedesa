...
class Anexossolicitudes extends CI_Controller {
...
//somos expertos
    ...
    public function eliminararchivo() {
     ...
     if($tipo==1){
        ...
        redirect('anexossolicitudes/acreditado?idregistro=' . $_SESSION["idregistro"], 'refresh');
    }
    if($tipo==2){

        redirect('anexossolicitudes/predial?idregistro=' . $_SESSION["idregistro"], 'refresh');
    }
    if($tipo==3){

        redirect('anexossolicitudes/escritura?idregistro=' . $_SESSION["idregistro"], 'refresh');
    }
    if($tipo==4){

        redirect('anexossolicitudes/plano?idregistro=' . $_SESSION["idregistro"], 'refresh');
    }
    if($tipo==5){

        redirect('anexossolicitudes/vendedor?idregistro=' . $_SESSION["idregistro"], 'refresh');
    }
    if($tipo==6){

        redirect('anexossolicitudes/boletaagua?idregistro=' . $_SESSION["idregistro"], 'refresh');
    }
    if($tipo==7){

        redirect('anexossolicitudes/licencia?idregistro=' . $_SESSION["idregistro"], 'refresh');
    }
    if($tipo==8){

        redirect('anexossolicitudes/fotos?idregistro=' . $_SESSION["idregistro"], 'refresh');
    }
...
public function acreditado() {
    ...
    $tipo = 1;
        ...
        $data['total'] = $total;
        $config['base_url'] = base_url() . 'anexossolicitudes/acreditado?nombre=' . $nombre . '&idregistro=' . $idregistro;
    ...
    $this->load->view('anexossolicitudes/listar', $data);
}
...
public function predial() {
    ...
    $tipo = 2;
        ...
        $total = $this->models_archivos->mostrarcount($nombre, $idregistro, $tipo);
        $data['total'] = $total;
        $config['base_url'] = base_url() . 'anexossolicitudes/predial?nombre=' . $nombre . '&idregistro=' . $idregistro;
        $config['total_rows'] = $total;
        $config['per_page'] = $this->limite; //Número de registros mostrados por páginas
        $config['num_links'] = 5; //Número de links mostrados en la paginación
        $config['page_query_string'] = true;
    ...
    $data['arryCount'] = $arrayArchivoscount;
    $this->load->view('anexossolicitudes/predial', $data);
}
...
public function escritura() {
    ...
    $tipo = 3;
        ...
        $total = $this->models_archivos->mostrarcount($nombre, $idregistro, $tipo);
        $data['total'] = $total;
        $config['base_url'] = base_url() . 'anexossolicitudes/escritura?nombre=' . $nombre . '&idregistro=' . $idregistro;
        $config['total_rows'] = $total;
        $config['per_page'] = $this->limite; //Número de registros mostrados por páginas
        $config['num_links'] = 5; //Número de links mostrados en la paginación
        $config['page_query_string'] = true;
    ...
    $data['arryCount'] = $arrayArchivoscount;
    $this->load->view('anexossolicitudes/escritura', $data);
}
...
public function plano() {
    ...
    $tipo = 4;
        ...
        $total = $this->models_archivos->mostrarcount($nombre, $idregistro, $tipo);
        $data['total'] = $total;
        $config['base_url'] = base_url() . 'anexossolicitudes/plano?nombre=' . $nombre . '&idregistro=' . $idregistro;
        $config['total_rows'] = $total;
        $config['per_page'] = $this->limite; //Número de registros mostrados por páginas
        $config['num_links'] = 5; //Número de links mostrados en la paginación
        $config['page_query_string'] = true;
    ...
    $data['arryCount'] = $arrayArchivoscount;
    $this->load->view('anexossolicitudes/plano', $data);
}
...
public function vendedor() {
    ...
    $tipo = 5;
        ...
        $total = $this->models_archivos->mostrarcount($nombre, $idregistro, $tipo);
        $data['total'] = $total;
        $config['base_url'] = base_url() . 'anexossolicitudes/vendedor?nombre=' . $nombre . '&idregistro=' . $idregistro;
        $config['total_rows'] = $total;
        $config['per_page'] = $this->limite; //Número de registros mostrados por páginas
        $config['num_links'] = 5; //Número de links mostrados en la paginación
        $config['page_query_string'] = true;
    ...
    $data['arryCount'] = $arrayArchivoscount;
    $this->load->view('anexossolicitudes/vendedor', $data);
}
...
public function boletaagua() {
    ...
    $tipo = 6;
        ...
        $total = $this->models_archivos->mostrarcount($nombre, $idregistro, $tipo);
        $data['total'] = $total;
        $config['base_url'] = base_url() . 'anexossolicitudes/boletaagua?nombre=' . $nombre . '&idregistro=' . $idregistro;
        $config['total_rows'] = $total;
        $config['per_page'] = $this->limite; //Número de registros mostrados por páginas
        $config['num_links'] = 5; //Número de links mostrados en la paginación
        $config['page_query_string'] = true;
    ...
    $data['arryCount'] = $arrayArchivoscount;
    $this->load->view('anexossolicitudes/boletaagua', $data);
}
...
public function licencia() {
    ...
    $tipo = 7;
        ...
        $total = $this->models_archivos->mostrarcount($nombre, $idregistro, $tipo);
        $data['total'] = $total;
        $config['base_url'] = base_url() . 'anexossolicitudes/licencia?nombre=' . $nombre . '&idregistro=' . $idregistro;
        $config['total_rows'] = $total;
        $config['per_page'] = $this->limite; //Número de registros mostrados por páginas
        $config['num_links'] = 5; //Número de links mostrados en la paginación
        $config['page_query_string'] = true;
    ...
    $data['arryCount'] = $arrayArchivoscount;
    $this->load->view('anexossolicitudes/licencia', $data);
}
...
public function fotos() {
    ...
    $tipo = 8;
        ...
        $total = $this->models_archivos->mostrarcount($nombre, $idregistro, $tipo);
        $data['total'] = $total;
        $config['base_url'] = base_url() . 'anexossolicitudes/fotos?nombre=' . $nombre . '&idregistro=' . $idregistro;
        $config['total_rows'] = $total;
        $config['per_page'] = $this->limite; //Número de registros mostrados por páginas
        $config['num_links'] = 5; //Número de links mostrados en la paginación
        $config['page_query_string'] = true;
   ...
   $datax['verSolicitudesBusqueda']=$boolenVer;
        ...
        $data['arryCount'] = $arrayArchivoscount;
        $this->load->view('anexossolicitudes/fotos', $data);
    }
    ...
    public function comentario() {
        ...
        $data['total'] = $total;
        $config['base_url'] = base_url() . 'anexossolicitudes/comentario?nombre=' . $nombre . '&idregistro=' . $idregistro;
        $config['total_rows'] = $total;
        $config['per_page'] = $this->limite; //Número de registros mostrados por páginas
        $config['num_links'] = 5; //Número de links mostrados en la paginación
        $config['page_query_string'] = true;
   ...
   $datax['verSolicitudesBusqueda']=$boolenVer;
        ...
        $data['arryCount'] = $arrayArchivoscount;
        $this->load->view('anexossolicitudes/comentarios', $data);
    }
    ...
    public function guaradarcomentario() {
        ...
        redirect('anexossolicitudes/comentario?idregistro=' . $_SESSION["idregistro"], 'refresh');
    }
